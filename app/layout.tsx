...
export const metadata: Metadata = {
  ...
  description: 'Premium fitness facility with world-class equipment, certified trainers, and 60+ weekly group classes. Membership plans from $29/month with a free 7-day trial.',
  formatDetection: {
    email: false,
    address: false,
    telephone: false,
