...
export default function TrainerCard({ item }: TrainerCardProps) {
  return (
    <Link
      href={item.path || '#'}
    ...
    >
      ...
      <div className="p-6">
        {(item as any).specialty && (
          <p className="text-sm text-primary-700 font-display font-medium uppercase tracking-wide mb-2">{(item as any).specialty}</p>
        )}
