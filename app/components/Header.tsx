...
import { Menu, X, Trophy, Phone, Mail, Clock } from 'lucide-react'
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              <Link
                href="/contact"
                className="hidden sm:inline-flex items-center bg-accent-400 text-primary-900 px-5 py-2 rounded-lg hover:bg-accent-300 transition-colors duration-200 font-display font-bold text-sm uppercase tracking-wide"
              >
                Join Now
              </Link>
            ...
            <div className="lg:hidden border-t border-gray-200 py-4">
              <nav className="flex flex-col space-y-1">
                ...
                <Link
                  href="/contact"
                  onClick={() => setMobileMenuOpen(false)}
                  className="mx-4 mt-2 text-center bg-accent-400 text-primary-900 px-5 py-3 rounded-lg font-display font-bold text-sm uppercase tracking-wide"
                >
                  Join Now
                </Link>
              </nav>
